...
I view life through the same lens I view software: as an infinite loop of learning, building, and optimizing.

Just as a codebase requires maintenance, my understanding of the world requires constant refactoring. I have made peace with the fact that I will never run out of questions, and that is a feature, not a bug.
...
- **Backend:** Node.js, Django, FastAPI, Postgres, Docker
- **AI/ML:** LLMs, LangChain, Mastra

---

### 📞 Connect

I am always open to discussing code, philosophy, or anything else that interests you.

[GitHub](https://github.com/jeevanmr) | [LinkedIn](https://linkedin.com/in/jeevanmr) | [Email](mailto:14.jeevan@gmail.com)
